...
import Tdd.Framework.dataProviderCode;

	public class TestLoginGrid4 extends  dataProviderCode {
		
		WebDriver driver;
	

	    public TestLoginGrid4(String filePath) throws IOException {
			super();
    ...
    void title1() throws MalformedURLException {
    	...
    	System.out.println("docker 1st title is  : " + title);
    	driver.close();
    }
    @Test(priority=2)
    void title2() throws MalformedURLException {
    	 ...
    	 driver.get("https://practicetestautomation.com/practice-test-login/");
    	String title= driver.getTitle();
    	System.out.println("docker 2nd title is  : " + title);
    	driver.close();
    }
	/*
